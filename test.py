...
weight_path = '/home/ykwei/Documents/Kaggle-Plant-Seedlings-Classification/weights/model.pth'
use_cuda = True
gpu_id = 0
...
def test():  
    ...
    with torch.no_grad():
        csvfile_test = open('/home/ykwei/Documents/Kaggle-Plant-Seedlings-Classification/sample_submission.csv')
        ...
        result = pd.read_csv('/home/ykwei/Documents/Kaggle-Plant-Seedlings-Classification/sample_submission.csv')
        plist = []
